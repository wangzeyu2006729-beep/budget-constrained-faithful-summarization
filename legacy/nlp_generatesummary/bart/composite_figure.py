...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='/path/to/NLP_generatesummary/bart/results/source_figure.png')
    parser.add_argument('--output', type=str, default='/path/to/NLP_generatesummary/bart/results/acl_figure_revised.png')
